...
\pagebreak\subsection{20161121-1}
    ...
    \mybox{
        \begin{enumerate}
            ...
            \item The DFT kernel is $w=e^{j\frac{2\pi}{2\cdot 1024}}=e^{j\frac{\pi}{1536}}$, so the $W$ matrix for the DFT will be $3072\times 3072$ matrix.
            ...
            However, since in this case the signal is input periodic and the number of samples considered is a multiple of the samples in a period no error will be introduced.
        \end{enumerate}
    }
