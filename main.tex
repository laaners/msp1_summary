...
\tableofcontents
    \include{sections/discrete_signals}
    \include{sections/lti}
    \include{sections/z_transform}
    \include{sections/dtft}
    \include{sections/dft}
    \include{sections/filters}
    \include{sections/matlab}
    \include{sections/exe}
\end{document}